package my.study.tdd.boardhexagonaltdd.article.adapter.in.api;

import jakarta.validation.Valid;
import java.util.List;
import my.study.tdd.boardhexagonaltdd.article.adapter.in.api.dto.ArticleDto;
import my.study.tdd.boardhexagonaltdd.article.adapter.in.api.dto.ArticleDto.ArticleResponse;
import my.study.tdd.boardhexagonaltdd.article.application.port.in.DeleteArticleUseCase;
import my.study.tdd.boardhexagonaltdd.article.application.port.in.GetArticleUseCase;
import my.study.tdd.boardhexagonaltdd.article.application.port.in.CreateArticleUseCase;
import my.study.tdd.boardhexagonaltdd.article.application.port.in.ModifyArticleUseCase;
import my.study.tdd.boardhexagonaltdd.common.api.dto.CommandResponse;
