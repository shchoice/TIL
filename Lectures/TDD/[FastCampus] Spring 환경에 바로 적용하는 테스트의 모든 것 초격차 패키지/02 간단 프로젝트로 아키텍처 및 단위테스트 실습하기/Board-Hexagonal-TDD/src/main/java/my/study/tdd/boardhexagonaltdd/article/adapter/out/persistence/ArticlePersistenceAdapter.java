package my.study.tdd.boardhexagonaltdd.article.adapter.out.persistence;

import java.util.List;
import java.util.Optional;
import my.study.tdd.boardhexagonaltdd.article.adapter.out.persistence.entity.ArticleJpaEntity;
import my.study.tdd.boardhexagonaltdd.article.adapter.out.persistence.repository.ArticleRepository;
