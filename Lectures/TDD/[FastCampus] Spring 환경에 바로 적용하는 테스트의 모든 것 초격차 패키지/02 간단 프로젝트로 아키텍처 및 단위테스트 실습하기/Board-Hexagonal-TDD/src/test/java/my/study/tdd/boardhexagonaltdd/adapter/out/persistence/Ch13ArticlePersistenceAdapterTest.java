...
import my.study.tdd.boardhexagonaltdd.domain.adapter.out.persistence.ArticlePersistenceAdapter;
...
import my.study.tdd.boardhexagonaltdd.out.persistence.ArticleJpaEntityFixtures;
...
class Ch13ArticlePersistenceAdapterTest {
  ...
  class CreateArticle {
    ...
    void createArticle_returnCreatedArticle() {
      ...
      var articleJpaEntity = new ArticleJpaEntity(
          boardJpaEntity,
          "subject",
          "content",
          "user",
